...
def list_blobs(target_bucket_url, prefix, bucket_credentials_file_path):
    """
    Lists names of blobs in a bucket.

    :param target_bucket_url: gs URL to the bucket in which to look for objects names. (i.e. of the form gs://<bucket-name>).
    :type target_bucket_url: str
    ...
    storage_client = storage.Client.from_service_account_json(bucket_credentials_file_path)
    parsed_bucket_url = urlparse(target_bucket_url)
